...
namespace Bb.CsharpGenerators
{
    ...
    public class SourceCodeDomGenerator
    {
        ...
        private SourceCodeDomGenerator(string[] usings)
        {

            this._fields = new Dictionary<object, CodeMemberField>();

            this._namespaceRoot = new CodeNamespace("Mynamespace");
            this._typeRoot = new CodeTypeDeclaration("MyClass");
        ...
        public static CodeNamespace GetCode(Expression e, params string[] usings)
        {
            SourceCodeDomGenerator s = new SourceCodeDomGenerator(usings);
            s.Visit(e);
        ...
        protected object VisitLambda(LambdaExpression node)
        {
            ...
            this._methodRoot = new CodeMemberMethod() { Name = "MyMethod", ReturnType = node.ReturnType.ToRefType(_usings), Attributes = MemberAttributes.Public };
